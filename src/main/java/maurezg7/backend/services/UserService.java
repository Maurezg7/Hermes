...
public class UserService {
    ...
    @Transactional
    public  Long getUserId(String userdata){
        User user = this.userRepository.findByUsernameOrEmail(userdata).orElseThrow(() -> new RuntimeException("Usuario no encontrado"));
        return user.getId();
    }
